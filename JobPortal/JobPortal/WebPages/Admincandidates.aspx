<%@ Page Title="" Language="C#" MasterPageFile="~/WebPages/Admin.Master" AutoEventWireup="true" CodeBehind="Admincandidates.aspx.cs" Inherits="JobPortal.WebPages.Admincandidates" %>
            ...
            <div class="ftco-search" style="padding: 0px 10px 0px 20px;">
                <div class="row">
                    ...
                    <div class="col-md-12 tab-wrap">
                            ...
                            <div class="tab-pane fade show active" id="v-pills-1" role="tabpanel" aria-labelledby="v-pills-nextgen-tab">
                                ...
                                <div class="team d-md-flex" style="    margin-bottom: 10px;" >
                                    ...
                                    <br />
                                           ...
                                           <asp:LinkButton CssClass="btn btn-success icon-check" ID='btnapp' Visible='<%#Convert.ToInt32(Eval("vacancy"))>0 ? true : false %>'  ValidationGroup='<%# Bind("ApplicationId") %>' CommandArgument='<%# Bind("ApplicationId") %>' CommandName="Approve"   runat="server"  ></asp:LinkButton>
                                    ...
                                    <asp:TextBox runat="server"   CssClass="form-control" Visible='<%#Convert.ToInt32(Eval("vacancy"))>0 ? true : false %>' width="70%" ID="rem" placeholder="Enter Remark" ></asp:TextBox>
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <div class="col-md-6" style="padding-top: 30px">
                                                    ...
                                                    <div class="team d-md-flex" style="margin-bottom: 0px; padding-left: 0px;">
                                                        ...
                                                        <div class="text pl-md-5">
                                                            <span class="location mb-0">
                                                                <asp:Label runat="server" ID="lbl" Text='<%# Eval("State") %>'></asp:Label></span><br />
                      ...
                      <asp:LinkButton CssClass="btn btn-success icon-check" ID='btnapp'  ValidationGroup='<%# Bind("ApplicationId") %>' CommandArgument='<%# Bind("ApplicationId") %>' CommandName="RApprove"   runat="server"  ></asp:LinkButton>
                                                     </p>
                                    </div>
                                    <asp:TextBox runat="server"   CssClass="form-control" width="70%" ID="rema" placeholder="Enter Remark" ></asp:TextBox>
