<%@ Page Title="" Language="C#" MasterPageFile="~/WebPages/Admin.Master" AutoEventWireup="true" CodeBehind="HRList.aspx.cs" Inherits="JobPortal.WebPages.HRList" %>
        ...
        <form runat="server">
            <asp:GridView runat="server" ID="grdHRList" AutoGenerateColumns="false" CellPadding="4" ForeColor="#333333" GridLines="None">
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="Frist Name" ItemStyle-Width="20%" DataField="Fname" />
