<%@ Page Title="" Language="C#" MasterPageFile="~/WebPages/Admin.Master" AutoEventWireup="true" CodeBehind="RegisterHR.aspx.cs" Inherits="JobPortal.UserResume.RegisterHR" %>
        ...
        <div class="container-login100" >
            <div class="wrap-reg100 p-l-55 p-r-55 p-t-37 p-b-54" style="margin-top: -500px; box-shadow: 0px 0px 11px 4px rgba(49,49,49,0.75); -webkit-box-shadow: 0px 0px 11px 4px rgba(49,49,49,0.75); -moz-box-shadow: 0px 0px 11px 4px rgba(49,49,49,0.75);">
                <form class="login100-form validate-form" runat="server">
                    ...
                    <div class="row col-md-12 ">
                        <div class=" col-md-6 " data-validate="Username is reauired">
                            <asp:RequiredFieldValidator runat="server" ForeColor="Red" ControlToValidate="mobile" ErrorMessage="* Please Enter MobileNo" Text="" ID="RequiredFieldValidator2"></asp:RequiredFieldValidator>
                ...
                --%>        </div>
                    ...
                    <div class="row col-md-12 ">
                        ...
                        <div class="col-md-6 ">
                            ...
                            <asp:RegularExpressionValidator ID="regpdff" Text="pdf files only" ForeColor="Red" ErrorMessage="please upload only pdf files" ControlToValidate="resume" ValidationExpression="^.*\.(pdf|PDF)$" runat="server" />
