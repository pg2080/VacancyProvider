<%@ Page Title="" Language="C#" MasterPageFile="~/WebPages/Navbar.Master" AutoEventWireup="true" CodeBehind="StudentDashboard.aspx.cs" Inherits="JobPortal.WebPages.Student1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="region" runat="server">
    		...
    		<div class="row justify-content-center">
    			<div class="col-md-10">
    				<div class="intro row text-center justify-content-center">
    					<div class="col-md-9">
    						<img class="img-fluid" src="../Assets/images/undraw_work_time_lhoj.svg" alt="">
    					</div>
   ...
   <form  runat="server" >
       <div id="studFeedbackModal" class="modal fade">
            <div class="modal-dialog modal-md">
                ...
                <div class="modal-content" role="dialog" style="border-bottom-right-radius: 30%; border-top-left-radius: 30%;">
                    <div class="modal-header" style="border-bottom-color: white;">
                        <h4 class="modal-title" style="padding-left: 37%"><b>Feed Back</b></h4>
                    ...
                    <div class="modal-body" style="padding: 23px">
                        <div class="row form-group">
                            <div class="col-md-12 mb-3 mb-md-0">
                                <label class="font-weight-bold" for="fullname">Cooming Soon</label>
                                <asp:TextBox runat="server" ID="txtUname" class="form-control" placeholder="Email or mobile number"></asp:TextBox>
                            </div>
                        </div>

                        <div class="row form-group">
                            <div class="col-md-12 mb-3 mb-md-0">
                                <label class="font-weight-bold" for="fullname">Oh</label>
                                <asp:TextBox runat="server" ID="txtPass" class="form-control" placeholder="Password"></asp:TextBox>
                            </div>
                        </div>
                        <div style="padding-left: 160px">
                            <asp:Button runat="server" class="btn btn-custom btn-lg" Text="Login"  />
                        </div>
                    </div>
                </div>
            </div>
